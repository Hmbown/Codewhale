...
- **Настольное приложение Codewhale (GPUI):** нативное настольное приложение GPUI — направление клиента продукта (решение от 2026-09-14; карта этапов — в docs/TRANSITION.md приватного репозитория codehwhale-gpui). Размещённое веб-приложение на app.codewhale.net выводится из эксплуатации поэтапно; маркетинговый сайт, вход, оплата, юридические страницы и страницы загрузки остаются в вебе навсегда. Сведения о доступности приведены на [странице продукта](https://codewhale.net/en/product).
