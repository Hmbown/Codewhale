...
export const INSTALL_GUIDE = {
  "sourceHash": "15d0f9dc73e2f7942318fcbe11ae820ec67118b9d8f1009c6ccc5caf49a98690",
  "anchors": [
  ...
  "chunks": [
    ...
    {
      "kind": "code",
      "text": "nix run github:Hmbown/CodeWhale -- --version"
    },
    {
      "kind": "html",
    ...
    {
      "kind": "code",
      "text": "rm ~/.local/bin/codewhale ~/.local/bin/codew\ncurl -fsSL https://codewhale.net/install.sh | CODEWHALE_VERSION=v0.9.13 sh\ncodewhale --version      # codewhale 0.9.13 (a0b81f619b66)"
    },
    {
      "kind": "html",
      "text": "<p>Or keep both versions side by side, and put the old one first on PATH:</p>\n"
    },
    {
      "kind": "code",
