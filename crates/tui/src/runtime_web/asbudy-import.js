...
(function () {
  ...
  document.head.appendChild((function () {
    ...
    st.textContent = [
      ...
      '.abx-btn{padding:10px 16px;border:1px solid #30363d;border-radius:8px;background:#0d1524;color:#e6edf3;font:inherit;font-size:.95em;cursor:pointer}',
      '.abx-btn:hover{border-color:#58a6ff}',
      '.abx-btn:disabled{opacity:.45;cursor:not-allowed}',
      '.abx-btn.abx-go{background:#1f6feb;border-color:#1f6feb;color:#fff}',
      '.abx-btn.abx-go:hover{border-color:#58a6ff}',
      '.abx-btn.abx-ghost{background:transparent}',
      '.abx-panel{margin:0 0 18px;padding:14px 16px;border:1px solid #30363d;border-radius:10px;background:#0b1220}',
      '.abx-h2{margin:0 0 12px;font-size:1.05em}',
      '.abx-row{display:flex;align-items:center;gap:10px;margin:10px 0}',
      '.abx-row>span{flex:0 0 56px;color:#8b949e;font-size:.9em}',
      '.abx-row input,.abx-row select{flex:1;min-width:0;padding:9px 11px;border:1px solid #30363d;border-radius:8px;background:#020711;color:#e6edf3;font:inherit;font-size:.95em}',
      '.abx-note{margin:8px 0 0;color:#8b949e;font-size:.88em;line-height:1.6}',
      '.abx-note.bad{color:#ff7a59}',
      '.abx-note.good{color:#3fb950}',
      '.abx-tip{margin:0 0 12px;padding:8px 10px;border:1px solid #d29922;border-radius:8px;background:#d299221a;color:#d29922;font-size:.88em;line-height:1.5}',
      '.abx-check{display:flex;gap:8px;align-items:flex-start;margin:12px 0 0;color:#8b949e;font-size:.9em;line-height:1.5}',
      '.abx-acts{display:flex;gap:10px;margin-top:14px}',
      '.abx-msg{margin-top:10px;min-height:1.2em;color:#8b949e;font-size:.9em;line-height:1.5}',
      '.abx-msg.bad{color:#ff7a59}',
      '.abx-msg.good{color:#3fb950}',
      '.abx-prog{margin-top:14px}',
      '.abx-prog .bar{height:8px;border-radius:99px;background:#1c2333;overflow:hidden}',
      '.abx-prog .bar>i{display:block;height:100%;width:0;background:#1f6feb;transition:width .25s}',
      '.abx-prog .txt{display:block;margin-top:6px;color:#8b949e;font-size:.85em}',
      '.abx-slim{position:fixed;left:0;right:0;bottom:0;z-index:60;padding:12px 16px 10px;background:#0b1220;border-top:1px solid #30363d;color:#8b949e;font-size:.88em}',
      '.abx-slim>i{position:absolute;left:0;top:0;height:3px;width:0;background:#1f6feb;transition:width .25s}',
    ].join('\n');
    return st;
  })());
